    ...
    iLotus.goTop = {
        ...
        _changeRight: function() {
            ...
            if(jQuery(window).width() > 1440) {
                right = parseInt((jQuery(window).width() - that.contenBigtWidth + 1)/4 - that.linkWidth - that.linkRight, 10);
            } else {

                right = parseInt((jQuery(window).width() - that.contentWidth + 1)/4 - that.linkWidth - that.linkRight, 10);
            }
            if( right < 20 ) {
                right = 20;
            }
